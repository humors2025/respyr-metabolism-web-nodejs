/**
 * get_weekly_tab_list_newtest.js
 *
 * Cloned from: get_weekly_tab_list.js — identical logic, but the
...
const get_weekly_tab_list_newtest = async (req, res) => {
  try {
    const body = req.body;
    ...
    console.error("get_weekly_tab_list_newtest error:", {
