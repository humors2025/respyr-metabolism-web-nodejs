/**
 * get_clients_data_total_missed_test_newtest.js
 *
 * Cloned from: get_clients_data_total_missed_test.js — identical logic, but the
...
const getMetabolismZone = (score) => {
  ...
  if (numericScore < 50) return "Building";
  if (numericScore >= 50 && numericScore < 70) return "Steady";
...
exports.get_clients_data_total_missed_test_newtest = async (req, res) => {
  ...
  try {
    ...
    console.error("get_clients_data_total_missed_test_newtest error:", safeLog);
