...
/**
 * food_json_suggestion_approve_plan_newtest.js
 *
 * Cloned from: food_json_suggestion_approve_plan.js — identical logic, but the
 ...
 *
 * Endpoint : POST /dietitian/api/web/food_json_suggestion_approve_plan_newtest
 ...
 *            in weekly_food_json_suggestions_newtest.
 *
 ...
 *  - Same DB table only: weekly_food_json_suggestions_newtest (read+write), plus the
...
/**
 * POST /dietitian/api/web/food_json_suggestion_approve_plan_newtest
 *
 * Headers: Authorization: Bearer <JWT>
 * Body:
 *   {
 *     "id": <int>,                 // weekly_food_json_suggestions_newtest.id
 ...
 *   }
 */
const foodJsonSuggestionApprovePlanNewtest = async (req, res) => {
  ...
  try {
    ...
    console.error("APPROVE_PLAN_NEWTEST_ERROR:", {
      code: err?.code,
      errno: err?.errno,
...
module.exports = { foodJsonSuggestionApprovePlanNewtest };
