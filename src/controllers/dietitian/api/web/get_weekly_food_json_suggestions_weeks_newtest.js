/**
 * get_weekly_food_json_suggestions_weeks_newtest.js
 *
...
const get_weekly_food_json_suggestions_weeks_newtest = async (req, res) => {
  try {
    const body = req.body;
    ...
    console.error("get_weekly_food_json_suggestions_weeks_newtest error:", {
